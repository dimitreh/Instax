#!/bin/bash
# Coded by: Dimitri is de lekkerste
# Instagram: Dimitri is de lekkerste
...
printf "\e[1;80m ) )| ||lekker  _ \  /___)(_  Dimitri _)(____ |  \e[0m\n"
printf "\e[1;77m(_/ | || | | ||___ |  | |_ / ___ |  \e[0m\n"
printf "\e[1;77m    |_||_| |_|(___/    \__)\__is___|  \e[0m\n"
printf "\n"
printf "\e[1;50m\e[40m  Instagram Brute Force Tool by @Dimitri Is Lekker(IG)   \e[0m\n"
printf "\n"
}
